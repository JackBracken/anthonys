    ...
    $('a#make-enquiry').click(function (e) {
        modal.open({
            ...
            <form action="/success" method="get">\n \
                ...
                <p>\n \
                    <input class="" type="submit" value="Make enquiry" id="modal_input"/>\n \
                </p>\n \
            </form>\n'
        });
        e.preventDefault();
        
        $('input[type=submit]#modal_input').click(function (f) {
            modal.open({
                content: "Thanks for enquiring! We'll be in touch soon."
            });
            f.preventDefault();
        });
    });
